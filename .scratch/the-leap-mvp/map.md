...
- [Daily Devotion as a nav item](./issues/11-daily-devotion-nav.md): its own screen in the Evolve Hub, distinct from Scripture, but converges into the shared Formation Session/Formation Loop where appropriate rather than becoming a parallel content system.
...
- [Books/Literature Library — IA placement](./issues/13-books-literature-library.md): reopens the deferral below; placed as the fourth Evolve Hub card. Content sourcing/format/sizing remain open — see ticket 15.
...
- [Iconography](./issues/14-nav-iconography.md): pick one canonical icon per movement (Connect/Commit/Evolve/Engage) and apply it consistently — currently inconsistent across the mockups.
- [Books & Literature content scope](./issues/15-books-library-content-scope.md): sourcing/licensing, format, Formation Domain relationship, and V1 sizing — ticket 13 only locked the IA placement, not the feature itself.
